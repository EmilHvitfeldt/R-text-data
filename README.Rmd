...
This **schrute** containscomplete script transcription for The Office (US) television show.
...
The data set includes the full transciption, line by line with metadata about episode number, season number, character, and more.
