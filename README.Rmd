...
The goal of this repository is to act as a collection of textural data set to be used for training and practice in text mining/NLP in R. This repository will not be a guide on how to do text analysis/mining but rather how to get a data set to get started with minimal hassle.
...
While the **text2vec** package is data package by itself, it does include a textural data set inside.
...
The **subtools** package doesn't include any textural data, but allows you to read subtitle files. 
